...
var Folder_name ="webfontsdrupaljsonwithouteditor";
...
function ajaxPage(currPage,pageStart,pageLimit,totalRecords,contentDiv,paginationDiv,url){
	...
	$.ajax({
		   type: "GET",
			...
			url: url,
			dataType: "json",
			data: {pageLimit:pageLimit,pageStart:pageStart,totalRecords:totalRecords,currentpage:currPage,contentDiv:contentDiv,paginationDiv:paginationDiv,url:url},
			success: function(msg){
